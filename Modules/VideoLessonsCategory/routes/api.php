...
Route::middleware(['web', 'auth'])->group(function () {
    Route::post('videolessonscategory/delete_selected_items', [VideoLessonsCategoryController::class, 'delete_selected_items'])
        ->middleware('checkpermission:18,4')
        ->name('videolessonscategory.delete_selected_items');
});
