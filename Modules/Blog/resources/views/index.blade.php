                    ...
                    <div class="grid grid-cols-12 lg:grid-cols-12 gap-3">
                        <div class="self-center col-span-12 lg:col-span-6">
                            <div style="display: flex; column-gap: 10px;width: max-content;" class="dataTables_length" id="alternativePagination_length">
                                <a style="height: 45px;display: flex; justify-content: center; align-items: center;" href="{{route('blog.create')}}" style="display: flex; justify-content: center; align-items: center; cursor: pointer" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">əlavə et</a>
                                ...
                                <form action="">
                                    <select class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 choices__input" name="selectedItems[]" multiple="multiple" id="mySelect" style="width: 300px;">
                                        ...
                                        <option @selected(in_array($category->id, $selectedItems)) value="{{$category->id}}">
                                            {{$category->title}}
                                        </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <tr class="group-[.stripe]:even:bg-slate-50 group-[.stripe]:dark:even:bg-zink-600 transition-all duration-150 ease-linear group-[.hover]:hover:bg-slate-50 dark:group-[.hover]:hover:bg-zink-600 [&amp;.selected]:bg-custom-500 dark:[&amp;.selected]:bg-custom-500 [&amp;.selected]:text-custom-50 dark:[&amp;.selected]:text-custom-50">
                                        ...
                                        <td>
                                            ...
                                            <div style="display: flex" class="d-flex">
                                             <div>
                                                    <a style="width: 30px; border: 1px solid black;display: flex; justify-content: center; align-items: center" class="arrow_up" href="{{route('blog.changeOrderUp', $item->id)}}" class="btn btn-phoenix-success me-1 mb-1" type="button">
                                                      ↑
                                                    </a>
                                                    <a style="width: 30px; border: 1px solid black; display: flex; justify-content: center; align-items: center" class="arrow_down" href="{{route('blog.changeOrderDown', $item->id)}}" class="btn btn-phoenix-success me-1 mb-1" type="button">
                                                      ↓
                                                    </a>
                                                </div>
                                                <a href="{{route('blog.edit', $item->id)}}" class="btn btn-phoenix-success me-1 mb-1" type="button">
                                                ...
                                                @if($activeItemsCount < 2 ) <a style="cursor: none" class="btn btn-phoenix-danger me-1 mb-1" type="link">
                                                    ...
                                                    @else
                                                    <a href="{{route('blog.changeStatusFalse',$item->id)}}" class="btn btn-phoenix-secondary me-1 mb-1 change_status_false" type="link">
                                                    ...
                                                    @endif
                                                    @else
                                                    <a href="{{route('blog.changeStatusTrue',$item->id)}}" class="btn btn-phoenix-secondary me-1 mb-1 change_status_true" type="button">
