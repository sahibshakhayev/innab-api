                    ...
                    <form enctype="multipart/form-data" method="post" action="{{route('customer.update', $customer->id)}}">
                        ...
                        <div style="margin-bottom: 10px">
                            <div style="display: flex; column-gap: 5px">
                                @foreach($customer->images->where('type', 'image') as $image)
                        ...
                        <div class="mb-3">
                            ...
                            @if($customer->images->where('type', 'image')->count() < 1)
                        ...
                        <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
                            <div class="mb-3">
                                <label for="inputText1" class="inline-block mb-2 text-base font-medium">Başlıq<span class="text-red-500">*</span></label>
                                <input type="text" id="inputText1" name="name" value="{{old('name', $customer->name)}}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                            </div>
                            <div class="mb-3">
                                <label for="inputText1" class="inline-block mb-2 text-base font-medium">Link<span class="text-red-500">*</span></label>
                                <input type="text" id="inputText1" name="link" value="{{old('link', $customer->link)}}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                            </div>
                        </div>
