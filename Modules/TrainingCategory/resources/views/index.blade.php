                                ...
                                <tbody>
                                    ...
                                    <tr class="group-[.stripe]:even:bg-slate-50 group-[.stripe]:dark:even:bg-zink-600 transition-all duration-150 ease-linear group-[.hover]:hover:bg-slate-50 dark:group-[.hover]:hover:bg-zink-600 [&amp;.selected]:bg-custom-500 dark:[&amp;.selected]:bg-custom-500 [&amp;.selected]:text-custom-50 dark:[&amp;.selected]:text-custom-50">
                                        ...
                                        <div style="display: flex" class="d-flex">
                                             <div>
                                                    <a style="width: 30px; border: 1px solid black;display: flex; justify-content: center; align-items: center" class="arrow_up" href="{{route('trainingcategory.changeOrderUp', $item->id)}}" class="btn btn-phoenix-success me-1 mb-1" type="button">
                                                      ↑
                                                    </a>
                                                    <a style="width: 30px; border: 1px solid black; display: flex; justify-content: center; align-items: center" class="arrow_down" href="{{route('trainingcategory.changeOrderDown', $item->id)}}" class="btn btn-phoenix-success me-1 mb-1" type="button">
                                                      ↓
                                                    </a>
                                                </div>
