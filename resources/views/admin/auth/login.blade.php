...
<head>
    ...
    <meta content="Innab Admin panel" name="description">
    <meta content="Innab Admin panel" name="author">
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ isset(ServiceFacade::getData()->header_top->url) && !empty(ServiceFacade::getData()->header_top->url) ? env('APP_URL') . '/' . ServiceFacade::getData()->header_top->url : '/favicon.ico' }}">
    ...
    <div class="relative">
        ...
        <div class="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                ...
                <a>
                    <img src="{{asset('storage/')}}/{{ServiceFacade::getData()->with('images')->first()->images->where('type', 'nav_logo')->first()->url}}" alt="" class="hidden h-6 mx-auto dark:block">
                    <img src="{{asset('storage/')}}/{{ServiceFacade::getData()->with('images')->first()->images->where('type', 'nav_logo')->first()->url}}" alt="" class="block h-6 mx-auto dark:hidden">
                </a>

                <div class="mt-8 text-center">
                    <h4 class="mb-1 text-custom-500 dark:text-custom-500">Xoş gəlmisiniz!</h4>
                    <p class="text-slate-500 dark:text-zink-200">Innab admin panelində işə davam etmək üçün davam etmək üçün daxil olun.</p>
                </div>
